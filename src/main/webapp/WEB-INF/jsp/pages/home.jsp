                                        ...
                                        <div class="post-head">
                                            ...
                                            <div class="post-head-right">
                                                <!-- <div class="dot"></div>
                                                    <div class="dot"></div>
                                                    <div class="dot"></div> -->
                                                <c:if test="${sessionScope.id==post.user.id}"><a
                                                        href="/editpost/${post.id}">Edit Post</a></c:if>
                                            </div>
                                        </div>
                                        <div class="post-body">
                                            ...
                                            <div class="comment-posting">
                                                <c:if test="${not empty sessionScope.email}"><img
                                                        class="comment-profile-pic"
                                                        src="/resources/uploads/${sessionScope.profile_pic}"
                                                        alt="Card image cap"></c:if>
                                                <div class="comment-post-details">

                                                    <c:if test="${not empty sessionScope.email}"><span
                                                            class="comment-box2" role="textbox" id="comment"
